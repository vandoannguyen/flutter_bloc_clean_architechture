...
import 'package:base_flutter_bloc/core/di/modules.dart' as _i389;
import 'package:base_flutter_bloc/features/app/presentation/bloc/app_bloc.dart'
    as _i559;
...
import 'package:base_flutter_bloc/features/auth/presentation/bloc/auth_bloc.dart'
    as _i150;
import 'package:base_flutter_bloc/features/home/domain/usecases/increment_counter_usecase.dart'
    as _i228;
import 'package:base_flutter_bloc/features/home/presentation/bloc/home_bloc.dart'
    as _i143;
import 'package:base_flutter_bloc/features/register_account/presentation/bloc/register_account_bloc.dart'
    as _i343;
...
extension GetItInjectableX on _i174.GetIt {
  ...
  _i174.GetIt init({
    ...
    gh.factory<_i228.IncrementCounterUseCase>(
      () => _i228.IncrementCounterUseCase(),
    );
    gh.factory<_i343.RegisterAccountBloc>(() => _i343.RegisterAccountBloc());
    ...
    gh.singleton<_i559.AppBloc>(() => _i559.AppBloc());
    ...
    gh.factory<_i143.HomeBloc>(
      () => _i143.HomeBloc(gh<_i228.IncrementCounterUseCase>()),
    );
...
class _$RegisterModule extends _i389.RegisterModule {}
