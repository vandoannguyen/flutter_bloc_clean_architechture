...
import 'package:base_flutter_bloc/bloc/app/app_bloc.dart' as _i5;
...
import 'package:base_flutter_bloc/common/logger/logger.dart' as _i4;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.singleton<_i3.Dio>(() => registerModule.prefs);
    gh.singleton<_i4.LogUtils>(() => _i4.LogUtils());
    gh.singleton<_i5.AppBloc>(() => _i5.AppBloc());
    gh.factory<_i6.ContentLocal>(() => _i7.ContentLocalImpl());
    gh.factory<_i8.ContentNetwork>(() => _i8.ContentNetwork(gh<_i3.Dio>()));
